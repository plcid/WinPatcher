...
// In 1.89.4, we moved the implementation of "courtesy maths operators" from imgui_internal.hpp in imgui.hpp
// As they are frequently requested, we do not want to encourage to many people using imgui_internal.hpp
#if defined(IMGUI_DEFINE_MATH_OPERATORS) && !defined(IMGUI_DEFINE_MATH_OPERATORS_IMPLEMENTED)
#error Please '#define IMGUI_DEFINE_MATH_OPERATORS' _BEFORE_ including imgui.hpp!
#endif
